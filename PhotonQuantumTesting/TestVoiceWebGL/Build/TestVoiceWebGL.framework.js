...
// end include: preamble.js
  ...
  function _PhotonStartUICopyToClipboard(textPtr) {
  ...
  function _PhotonVoice_WebAudioAudioOut_GetOutPos(handle) {
  ...
  function _PhotonVoice_WebAudioAudioOut_ResumeAudioContext() {
          if (Module.PhotonVoice_WebAudioAudioOut_Global) {
              Module.PhotonVoice_WebAudioAudioOut_Global.ResumeAudioContext();
          }
      }

  function _PhotonVoice_WebAudioAudioOut_SetListenerOrientation(handle, fx, fy, fz, ux, uy, uz) {
          const ctx = Module.PhotonVoice_WebAudioAudioOut_Global.Sources.get(handle);
          if (ctx) {
  ...
  function _PhotonVoice_WebAudioAudioOut_SetListenerPosition(handle, x, y, z) {
          const ctx = Module.PhotonVoice_WebAudioAudioOut_Global.Sources.get(handle);
          if (ctx) {
  ...
  function _PhotonVoice_WebAudioAudioOut_SetMaxDistance(handle, x) {
          const ctx = Module.PhotonVoice_WebAudioAudioOut_Global.Sources.get(handle);
  ...
  function _PhotonVoice_WebAudioAudioOut_SetPosition(handle, x, y, z) {
          const ctx = Module.PhotonVoice_WebAudioAudioOut_Global.Sources.get(handle);
          if (ctx && ctx.pannerNode) {
  ...
  function _PhotonVoice_WebAudioAudioOut_SetRefDistance(handle, x) {
          const ctx = Module.PhotonVoice_WebAudioAudioOut_Global.Sources.get(handle);
          if (ctx && ctx.pannerNode) {
  ...
  function _PhotonVoice_WebAudioAudioOut_SetSpatialBlend(handle, x) {
          const ctx = Module.PhotonVoice_WebAudioAudioOut_Global.Sources.get(handle);
  ...
  function _PhotonVoice_WebAudioAudioOut_SetVolume(handle, x) {
          const ctx = Module.PhotonVoice_WebAudioAudioOut_Global.Sources.get(handle);
          if (ctx) {
  ...
  function _PhotonVoice_WebAudioAudioOut_Start(handle, sampleRate, channels, bufferSamples, spatialBlend) {
          if (!Module.PhotonVoice_WebAudioAudioOut_Global) {
  ...
  function _PhotonVoice_WebAudioAudioOut_Stop(handle) {
          const ctx = Module.PhotonVoice_WebAudioAudioOut_Global.Sources.get(handle);
          if (ctx) {
  ...
  function _PhotonVoice_WebAudioAudioOut_Write(handle, data, dataLenFloat, offsetSamples) {
          const ctx = Module.PhotonVoice_WebAudioAudioOut_Global.Sources.get(handle);
          if (ctx) {
  ...
  function _PhotonVoice_WebAudioMicIn_Start(handle, deviceId, createCallback, dataCallback) {
  ...
  */
                      ...
                      navigator.mediaDevices.getUserMedia({
                          ...
                          .then(function(stream) {
                              ...
                              worklet.port.onmessage = function(e) {
                                  ...
                                  getWasmTableEntry(dataCallback)(handle, ptr, b.length);
                                  _free(ptr);
                              }
                              audioContext.resume();
                              ...
                              getWasmTableEntry(createCallback)(handle, 0, audioContext.sampleRate, 1);
                          })
                          .catch(function(err) {
                              ...
                              getWasmTableEntry(createCallback)(handle, 2, 0, 0);
                          });
                  },
                  function(err) {
                      ...
                      if (Module.PhotonVoice_WebAudioMicIn_InputsStopped) {
                       ...
                       getWasmTableEntry(createCallback)(handle, 3, 0, 0);
                  }
              );
  
          } else {
              console.error('[PV] PhotonVoice_WebAudioMicIn_Start error: ' + 'getUserMedia not supported on your browser!');
              getWasmTableEntry(createCallback)(handle, 1, 0, 0);
          }
      }

  function _PhotonVoice_WebAudioMicIn_Stop(handle) { 
  ...
  function _PhotonVoice_WebRTC_EnumerateDevices(requestId, kind, resultCallback) {
          ...
          if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia && navigator.mediaDevices.enumerateDevices) {
              navigator.mediaDevices.getUserMedia({ audio: kindStr.startsWith("audio"), video: kindStr.startsWith("video") }).then(function(stream) {
                  navigator.mediaDevices.enumerateDevices().then(devices => {
                      ...
                      getWasmTableEntry(resultCallback)(requestId, 0, ptr, res.length);
                  ...
                  .catch(function(err) {
                      ...
                      getWasmTableEntry(resultCallback)(requestId, 1, 0, 0);
                  });
              })
              .catch(function(err) {
                  console.error('[PV] PhotonVoice_WebRTC_EnumerateDevices enumerateDevices permission error: ' + err);
                  getWasmTableEntry(resultCallback)(requestId, 2, 0, 0);
              });
          } else {
              console.error('[PV] PhotonVoice_WebRTC_EnumerateDevices error: ' + 'enumerateDevices not supported on your browser!');
              getWasmTableEntry(resultCallback)(requestId, 3, 0, 0);
          }
      }

  function _Photon_JS_TimerWorker_Start(callback, interval) {
          ...
          worker.onmessage = () => { getWasmTableEntry(callback)(handle); }
          worker.postMessage(interval);
          Module.PhotonVoice_TimerWorker_Global.Handles[handle] = worker;
          return handle;
      }

  function _Photon_JS_TimerWorker_Stop(handle) {
  ...
  function _QuantumCopyToClipboard(textPtr) {
          var text = UTF8ToString(textPtr);
...
var wasmImports = {
  ...
  "PhotonStartUICopyToClipboard": _PhotonStartUICopyToClipboard,
  "PhotonVoice_WebAudioAudioOut_GetOutPos": _PhotonVoice_WebAudioAudioOut_GetOutPos,
  "PhotonVoice_WebAudioAudioOut_ResumeAudioContext": _PhotonVoice_WebAudioAudioOut_ResumeAudioContext,
  "PhotonVoice_WebAudioAudioOut_SetListenerOrientation": _PhotonVoice_WebAudioAudioOut_SetListenerOrientation,
  "PhotonVoice_WebAudioAudioOut_SetListenerPosition": _PhotonVoice_WebAudioAudioOut_SetListenerPosition,
  "PhotonVoice_WebAudioAudioOut_SetMaxDistance": _PhotonVoice_WebAudioAudioOut_SetMaxDistance,
  "PhotonVoice_WebAudioAudioOut_SetPosition": _PhotonVoice_WebAudioAudioOut_SetPosition,
  "PhotonVoice_WebAudioAudioOut_SetRefDistance": _PhotonVoice_WebAudioAudioOut_SetRefDistance,
  "PhotonVoice_WebAudioAudioOut_SetSpatialBlend": _PhotonVoice_WebAudioAudioOut_SetSpatialBlend,
  "PhotonVoice_WebAudioAudioOut_SetVolume": _PhotonVoice_WebAudioAudioOut_SetVolume,
  "PhotonVoice_WebAudioAudioOut_Start": _PhotonVoice_WebAudioAudioOut_Start,
  "PhotonVoice_WebAudioAudioOut_Stop": _PhotonVoice_WebAudioAudioOut_Stop,
  "PhotonVoice_WebAudioAudioOut_Write": _PhotonVoice_WebAudioAudioOut_Write,
  "PhotonVoice_WebAudioMicIn_Start": _PhotonVoice_WebAudioMicIn_Start,
  "PhotonVoice_WebAudioMicIn_Stop": _PhotonVoice_WebAudioMicIn_Stop,
  "PhotonVoice_WebRTC_EnumerateDevices": _PhotonVoice_WebRTC_EnumerateDevices,
  "Photon_JS_TimerWorker_Start": _Photon_JS_TimerWorker_Start,
  "Photon_JS_TimerWorker_Stop": _Photon_JS_TimerWorker_Stop,
  "QuantumCopyToClipboard": _QuantumCopyToClipboard,
