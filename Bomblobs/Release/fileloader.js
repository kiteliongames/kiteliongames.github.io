...
(function() {
    ...
    var REMOTE_PACKAGE_SIZE = 12043161;
    var PACKAGE_UUID = 'ce6c1569-8ce8-4934-b315-a8144e256b13';
...
Module['FS_createPath']('/', 'Resources', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 61704, 0, 0).open('GET', '/level0');
    new DataRequest(61704, 108448, 0, 0).open('GET', '/level1');
    new DataRequest(108448, 155192, 0, 0).open('GET', '/level2');
    new DataRequest(155192, 205768, 0, 0).open('GET', '/level3');
    new DataRequest(205768, 271352, 0, 0).open('GET', '/level4');
    new DataRequest(271352, 337144, 0, 0).open('GET', '/level5');
    new DataRequest(337144, 416776, 0, 0).open('GET', '/mainData');
    new DataRequest(416776, 416797, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(416797, 422573, 0, 0).open('GET', '/resources.assets');
    new DataRequest(422573, 8781093, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(8781093, 8787949, 0, 0).open('GET', '/sharedassets1.assets');
    new DataRequest(8787949, 8794805, 0, 0).open('GET', '/sharedassets2.assets');
    new DataRequest(8794805, 8801661, 0, 0).open('GET', '/sharedassets3.assets');
    new DataRequest(8801661, 8808517, 0, 0).open('GET', '/sharedassets4.assets');
    new DataRequest(8808517, 8815385, 0, 0).open('GET', '/sharedassets5.assets');
    new DataRequest(8815385, 8822253, 0, 0).open('GET', '/sharedassets6.assets');
    new DataRequest(8822253, 9965473, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(9965473, 11540509, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(11540509, 12043161, 0, 0).open('GET', '/Resources/unity_builtin_extra');
