...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'EZ_SysInfo.data';
    var REMOTE_PACKAGE_BASE = 'EZ_SysInfo.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 2906892;
      var PACKAGE_UUID = '5001fd76-829b-4ae9-bf21-fcf073bd168f';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 130691, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(130691, 130712, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(130712, 133583, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(133583, 2004295, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(2004295, 2879267, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(2879267, 2906892, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_EZ_SysInfo.data');

    };
    Module['addRunDependency']('datafile_EZ_SysInfo.data');
